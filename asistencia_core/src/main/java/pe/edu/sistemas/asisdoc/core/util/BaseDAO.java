...
public class BaseDAO {
	...
	public static void cerrarConexion(Connection con) throws RuntimeException
	{
		try {
	...
	public static void cerrarResultSet(ResultSet rs) throws RuntimeException 
	{
		try {
			if (rs != null) {
				rs.close();
	...
	public static void cerrarCallable(CallableStatement callstmt)
			throws RuntimeException 
	{
		try {
			if (callstmt != null) {
